...
const BLOG = {
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js','https://cdn.nankoyo.com/public/cache/blog/js/cf-cdn.js','https://v1.hitokoto.cn/?encode=js&select=%23hitokoto','https://api.concord.tech/site-v1/3bd6e943-99d3-470c-bf0e-e0265d839690/site-client'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
